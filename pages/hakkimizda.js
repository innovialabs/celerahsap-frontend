			...
			<div className='row row__medium-10'>
				...
				<Image src="/images/celer001.png" width="800" height="400"   />
					...
					<div className='page-section__text'>
						...
						<div className='empty-space'></div> Günümüzde Çeler Ahşap ve
						...
						Kıbrıs'ta sektörün önde gelen firmaları arasındadır.{' '}
						<div className='empty-space'></div> Firmamız mutfak, kapı, dolap ve
						çardak ürünleri ve birbirinden farklı tasarımlara sahip dekorasyon
						hizmeti ile beklentilerinizi en üst seviyede karşılamak için yanı
						başınızdadır.
					</div>
